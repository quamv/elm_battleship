    ...
    describe "isUsedSpottests" <|
        ...
        , test "6b" <|
            \() ->
                ...
                <|
                    List.all (\idx -> isUsedSpot idx ships) <|
                        List.range 0 3
                            ++ [ 4 ]
        , test "7" <|
            \() ->
                ...
                <|
                    List.any (\idx -> isUsedSpot idx ships) <|
                        List.range 15 99
                            ++ [ 4, 5, 6, 7, 8, 9 ]
        , test "8" <|
            \() ->
        ...
        , test "6b" <|
            \() ->
                Expect.false
                    "mixed coords detected"
                <|
                    List.all (\idx -> coordsOccupiedByAnyShip [ idx ] ships) <|
                        List.range 0 3
                            ++ [ 4 ]
        , test "7" <|
            \() ->
                Expect.false
                    "all non-coords detected"
                <|
                    List.any (\idx -> coordsOccupiedByAnyShip [ idx ] ships) <|
                        List.range 15 99
                            ++ [ 4, 5, 6, 7, 8, 9 ]
        , test "8" <|
            \() ->
        ...
        , test "6b" <|
            \() ->
                Expect.false
                    "mixed coords detected"
                <|
                    List.all (\idx -> coordsOccupiedByShip [ idx ] destroyer) <|
                        List.range 0 3
                            ++ [ 4 ]
        , test "7" <|
            \() ->
        ...
        , test "9" <|
            \() ->
                Expect.true
                    "mixed detected"
                <|
                    List.any (\idx -> coordsOccupiedByShip [ idx ] destroyer) <|
                        2
                            :: List.range 4 99
        , test "9b" <|
            \() ->
