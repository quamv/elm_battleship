    ...
    let
        ( originalships, originalshots ) =
            ...
            case model.playerTurn of
                PlayerSide1 ->
                    ( model.p2ships, model.p1shots )

                PlayerSide2 ->
                    ( model.p1ships, model.p2shots )
        ...
        newmodel =
            ...
            case model.playerTurn of
                PlayerSide1 ->
                    { model | p2ships = newships, p1shots = newshots }

                PlayerSide2 ->
                    { model | p1ships = newships, p2shots = newshots }
